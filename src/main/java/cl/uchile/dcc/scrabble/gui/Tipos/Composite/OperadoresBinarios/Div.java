...
public class Div implements OperadorFloat, OperadorInt, OperadorBinary {

    Operador nodoizq;
    Operador nodoDer;


    public Div(Operador nodoizq,Operador nodoDer){
    ...
    public Element eval() {
        ...
        IRealNumbers Tipo2=(IRealNumbers) nodoDer.eval().getTipo();
        return new Element(Tipo.Div((IRealNumbers) nodoDer.eval().getTipo()));
